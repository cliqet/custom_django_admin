"""
    Override django's django.core.cache.backends.redis.RedisCache
    to use json instead of pickle. All other methods in django's cache
    remains the same
    NOTE: This is only used for djangorq and admin sessions.
"""
