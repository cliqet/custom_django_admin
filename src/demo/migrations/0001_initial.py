    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classification', models.ManyToManyField(to='demo.classification', verbose_name='Classification')),
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='demo.type', verbose_name='Type')),
            ],
            options={
                'abstract': False,
            },
